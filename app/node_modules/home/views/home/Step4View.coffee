deps = [
    ...
    'umd-core/src/components/ModelListener'
    'umd-core/src/components/InputText'
    'umd-core/src/components/InputWithError'
    'umd-core/src/components/AutogrowTextarea'
]

freact = ({_, Backbone, i18n}, ReactModelView, validators, ModelListener, InputText, InputWithError, AutogrowTextarea)->

    states = ('AL AK AZ AR CA CO CT DE FL GA HI ID IL IN IA KS KY LA ME MD MA MI MN MS MO MT NE NV NH NJ NM NY NC ND OH OK OR PA RI SC SD TN TX UT VT VA WA WV WI WY').split(' ').map (state) ->
        { abbrev: state }
    ...
    class UserModel extends Backbone.Model
        validation:
            ...
            postalCode: [
                validators.required()
                validators.pattern /^[0-9]{5}$/, msg: (code, {field, pattern})->
                    i18n.t 'error.postalCode'
            ]
            biography: validators.maxLength(150)

    class Step4View extends ReactModelView
        initialize: ->
            @user = new UserModel
                title: 'Spy'
        ...
        render: ->
            ...
            `<form onSubmit={this.save} className="container">
                ...
                */}
                <ModelListener model={user} events="vstate" onEvent={function(isValid, model, invalidAttrs) { return (
                ...
                <div className="clearfix">
                    {/*
                        ...
                        ReactLink works in a similar way: https://facebook.github.io/react/docs/two-way-binding-helpers.html
                    */}

deps = [
    ...
    'umd-core/src/components/Dialog'
    'umd-core/src/components/AbstractModelComponent'
    '../test/mock' # Simulate ajax calls to /rest/users
]

freact = ({ _, $, Backbone, i18n }, ClientController, BackboneCollection, ReactModelView, ReactCollectionView, InputText, InputWithError, validators, Dialog, AbstractModelComponent)->
    ...
    class EditView extends ReactModelView
        ...
        saveUser: (evt)=>
            ...
            if not invalidAttrs
                user.save null, success: @onSave
            return

        deleteUser: (evt)=>
            evt.preventDefault()
            @props.model.destroy success: @onDelete
            return

    ...
    class AppRouter extends BasicRouter
        ...
        routes: ->
            ...
            '{build:(app|web)}/{language}/{module}/{controller}/{action}/*':
                ...
                # page title we would like to set
                title: '{module}.{controller}.{action}.title'
        ...
        onRouteChangeSuccess: (rendable, current)->
            # Set the page title.
            # rendable has multiple definition.
            # The method 'getRendableTitle' will take care of the multiple definitions
            if title = @getRendableTitle rendable
                document.title = i18n.t(title) + ' - Tutorial'
